...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "border-brutal bg-card text-card-foreground shadow-brutal transition-brutal hover:shadow-brutal-lg hover:-translate-y-1",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-base font-medium text-muted-foreground leading-relaxed", className)}
    {...props}
  />
))
